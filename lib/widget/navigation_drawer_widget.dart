...
import 'package:onboarding_drawer_save_prefs/page/user_page.dart';

class NavigationDrawerWidget extends StatelessWidget {
  final padding = EdgeInsets.symmetric(horizontal: 20);
  @override
  Widget build(BuildContext context) {
    final name = 'FlutterCrypto';
    final email = 'fluttercrypto@gmx.de';
    ...
    final urlImage = 'assets/flutter_crypto_raw2.png';
    return Drawer(
      child: Material(
